...
const folder_input_1 = require("../application/dto/folder.input");
...
let FolderController = class FolderController {
    constructor(folderService, folderFeedService, createFolderService, updateFolderService, removeFolderService) {
        this.folderService = folderService;
        this.folderFeedService = folderFeedService;
...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], FolderController.prototype, "getFeed", null);
