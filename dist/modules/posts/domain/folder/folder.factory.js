...
let FolderFactory = class FolderFactory {
    constructor(folderRepository) {
        this.folderRepository = folderRepository;
    }
    async create(input) {
        const folder = new folder_entity_1.Folder(Object.assign(Object.assign({}, input), { userId: new id_1.ID(input.userId) }));
        return this.folderRepository.save(folder);
    }
};
FolderFactory = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [folder_orm_repository_1.FolderOrmRepository])
], FolderFactory);
exports.FolderFactory = FolderFactory;
//# sourceMappingURL=folder.factory.js.map