...
const post_orm_entity_1 = require("./infra/post/post.orm.entity");
...
const post_orm_mapper_1 = require("./infra/post/post.orm.mapper");
...
PostModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([post_orm_entity_1.PostOrm]), user_module_1.UserModule, folder_module_1.FolderModule],
        providers: [
